//API PARA BUSCAR INFORMAÇÕES DA LOCALIZAÇÃO
...
//SALVA QUAL FOI A MAIOR VELOCIDADE ATINGIDA
...
//CALCULA A DISTANCIA ENTRE O INICIO E O FIM DA CORRIDA
...
//DATA EM QUE A CORRIDA FOI CRIADA
function getStartDate(ride) {
    ...
    const minute = d.toLocaleString("en-US", {
        minute: "2-digit"
    })
